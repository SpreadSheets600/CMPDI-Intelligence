...
fused with Reciprocal Rank Fusion. Results are not the source of truth; each
one carries its provenance chain (chunk, element, page, document, file)."""
...
from backend.core.pipeline.embedder import embed_texts, vector_matrix
