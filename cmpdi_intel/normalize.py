...
# No global trailing \b: '%' and '/' are non-word chars and would never satisfy
# it — instead each alphabetic unit gets its own \b so "31 March" cannot match
# unit "m" inside "March". Lookbehind stops "2021-22" yielding "-22".
