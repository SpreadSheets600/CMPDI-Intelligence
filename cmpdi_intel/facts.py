...
from .normalize import context_unit, detect_attribute, normalize_period, parse_quantity
...
def _facts_from_text_chunk(chunk, period, patterns, ocr_low):
    ...
    for i, m in enumerate(matches):
        raw = m.group(0).strip()
        # the period relevant to a number usually sits right after it, up to
        # the next number ("...157.30 MT during FY2021-22, against 143.85 MT
        # in the previous year...") — the 'previous year' phrase belongs to
