...
order honours CMPDI_LLM_BACKEND; "auto" probes Ollama, then a locally cached
HF model, then extractive. Generation is always optional — the platform
degrades to cited evidence snippets, never to hallucination."""
